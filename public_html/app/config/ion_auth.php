 ...
 */
$config['site_title']                 = "Backend-CI";       // Site Title, example.com
$config['admin_email']                = "admin@isdemo.site"; // Admin Email, admin@example.com
$config['default_group']              = 'clients';           // Default group, use name
...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'backend/template/email/';
